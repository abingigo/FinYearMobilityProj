...
public class WeightedMajority implements DecisionMigration {
	...
	public WeightedMajority(List<FogDevice> serverCloudlets,
	...
	public boolean shouldMigrate(MobileDevice smartThing) {
		...
		if (!(smartThing.isMigPoint() && smartThing.isMigZone())) {
			...
			setNextServerClouletId(Migration.weightedMajorityServerCloudlet(serverCloudlets, apDevices, smartThing));
